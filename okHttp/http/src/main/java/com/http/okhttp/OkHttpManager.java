...
public class OkHttpManager {
    ...
    public void execute(final Request request, ResultCallback callback) {
        if (callback == null) callback = ResultCallback.mCallback;
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(final Request request, final IOException e) {
                ...
                sendFailCallback(request, e, resCallBack);
            }
            ...
            public void onResponse(final Response response) {
                if (response.code() != 200) {
                    try {
                        sendFailCallback(request, new RuntimeException(response.body().string()), resCallBack);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    return;
                ...
                try {
                    ...
                    if (resCallBack.mType == String.class) {
                        sendSuccessCallback(string, resCallBack);
                    } else {
                        Object o = mGson.fromJson(string, resCallBack.mType);
                        sendSuccessCallback(o, resCallBack);
                    }
                } catch (IOException e) {
                    sendFailCallback(response.request(), e, resCallBack);
    ...
    public void sendFailCallback(final Request request, final Exception e, final ResultCallback callback) {
    ...
    public void sendSuccessCallback(final Object object, final ResultCallback callback) {
        if (callback == null) return;
        mDelivery.post(new Runnable() {
            @Override
            public void run() {
