...
public class PostRequest extends OkHttpRequest
{
    ...
    protected PostRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, MediaType mediaType, String content, byte[] bytes, File file)
    {
